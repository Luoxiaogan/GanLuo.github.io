...
\definecolor{themecolor}{RGB}{99,142,201}
\definecolor{urlcolor}{RGB}{11, 37, 139}
...
% 修改后的head命令 - homepage链接放在右边，删除phone
\newcommand*{\head}{\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
            ...
            & \homepagesymbol \href{\Home}{\color{themecolor!70!white}{\Home}} \\
      \end{tabular*}}